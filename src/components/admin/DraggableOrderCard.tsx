...
export function DraggableOrderCard({ order, onUpdateStatus, isNew = false }: DraggableOrderCardProps) {
  ...
  return (
    <div
      ...
      className={cn(
        'relative bg-card border border-border/50 rounded-xl overflow-hidden transition-all duration-300 cursor-grab active:cursor-grabbing',
        ...
        isDragging && 'opacity-50 scale-95 ring-2 ring-primary shadow-xl'
      )}
    >
